...
public:
    ...
    static bool checkBottom (Cube& C)
    {
        ...
        {
          if (C.F[RED].sqr[6] == RED && C.F[RED].sqr[8] == RED && C.F[GREEN].sqr[6] == GREEN && C.F[GREEN].sqr[8] == GREEN &&
             C.F[BLUE].sqr[6] == BLUE && C.F[BLUE].sqr[8] == BLUE &&C.F[ORANGE].sqr[6] == ORANGE && C.F[ORANGE].sqr[8] == ORANGE )
                return true;
        }
        return false;
    }
